...
//                            }
                            ...
                            NSLog(@"Sending fetch result failed");
                            [EnmoManager shared].fetchCompletionHandler(UIBackgroundFetchResultFailed);
...
//                            }
                            ...
                            [EnmoManager shared].fetchCompletionHandler(UIBackgroundFetchResultNewData);
                            [EnmoManager shared].fetchCompletionHandler =  nil;
                        }
...
//	[ NSUserDefaults resetStandardUserDefaults ];
	...
	//AppDelegate * delegate = ( AppDelegate * ) [ UIApplication sharedApplication ].delegate; //Commented FL

	//[ delegate stop3rdPartyRanging ]; //Commented FL
    
    [self.stopRangingDelegate rulesManagerDidStop3rdPartyRanging];
